...
import { burgundy, black, white } from '../utils/colors'
...
function Score(props){
    ...
    return(
        <View style={styles.center}>
            ...
            <TouchableOpacity
             style={[styles.btn, {backgroundColor: burgundy, marginTop: 25}]}
             onPress={restart}
            >
            ...
            >
                <Text style={[styles.btnText, {color: burgundy}]}>Back to Deck</Text>
            </TouchableOpacity>
        </View>
    )
}
